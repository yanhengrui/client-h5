...
Windows 演示环境可直接双击 `start-frontend.cmd`。脚本默认代理到 CLB `http://9.135.56.72`，自动检查 Node/npm、首次安装依赖、启动 Vite 并打开浏览器。也可以传入自定义后端和端口：

```powershell
.\start-frontend.cmd http://9.135.56.72 5173
```
